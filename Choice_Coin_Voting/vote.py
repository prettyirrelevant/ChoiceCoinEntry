...
# Escrow creation.
escrow_address = (
    "QBOKU324UXMAMQOR4UC4R7LZ34WSQNNAUO5PCF33TKAJI65V6H6IGZROFI"  # Put in main fund address here
)
escrow_mnemonic = "focus crawl quit anger expand unaware useful crash duck wealth result night nice rack shoe sight dilemma tuition lava what garbage quantum radio about wire"  # Put in main fund receiver_mnemonic here
...
clawback_address = "XS4P7JEZZYTDYC6XEI2KRIRNT4VVC3PAQLUPVVQQGSG7EZCF7OX6Y2TITU"
clawback_mnemonic = "treat convince try melt marriage coast yard include inhale dash body rubber cigar address foam assist hammer cloth slush atom orient impulse tent abandon toward"
